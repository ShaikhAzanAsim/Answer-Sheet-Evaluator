...
class ImageOCRAnalyzer:
    ...
    def perform_ocr(
        self, image_base64=None, prompt="", temperature=0.5, max_tokens=1024, top_p=1
    ):
        """
...
class AssessmentTool:
    ...
    def extract_student_response(self, student_image_paths):
        ...
        for image_path in student_image_paths:
            ...
            prompt = (
                "You are an advanced OCR assistant tasked with analyzing a handwritten student response image. "
                "Your goal is to extract all the text as accurately as possible, preserving the structure and format, including:\n\n"
                "- Headings and subheadings.\n"
                "- Numbered lists and bullet points.\n"
                "- Any underlined or emphasized text.\n\n"
                "**Instructions**:\n"
                "1. Transcribe handwritten text verbatim, even if cursive.\n"
                "2. Clearly indicate `[unclear]` for any text that is illegible or ambiguous.\n"
                "3. Maintain the natural order of the text, including any indents or spacing that suggests hierarchy.\n\n"
                "**Formatting Example**:\n"
                "```\n"
                "Question 1:\n"
                "- Answer: DevOps refers to ...\n"
                "- Benefits:\n"
                ...
                "     ...\n"
                "```\n\n"
                "Focus on extracting information accurately, preserving the logical flow, and indicating uncertainty where necessary."
            )
